...
namespace FluentValidationApp.Web.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(AddDbContext context,IValidator<Customer> customervalidator)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customers != null ? 
                          ...
                          Problem("Entity set 'AddDbContext.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AddDbContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
